...
module reservation_station_div #(
    parameter DEPTH = 4, // Fewer entries needed for DIV
    ...
    // Identical wakeup/select CAM logic as ALU stations, but feeds the Multi-cycle Divider.
