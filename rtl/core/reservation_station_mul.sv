...
module reservation_station_mul #(
    parameter DEPTH = 4, // Fewer entries needed for MUL
    ...
    // Identical wakeup/select CAM logic as ALU stations, but feeds the Multiplier Pipeline.
